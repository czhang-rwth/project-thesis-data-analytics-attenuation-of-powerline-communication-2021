...
for temp30_file in os.listdir(file30m):
    ...
    for temp10_file in os.listdir(file10m):
        ...
        if temp10 == temp30:
            ...
            ax1.plot(freq10, dampf_achse, temp10)

ax1.set_xlabel('Frequenz [MHz]')
ax1.set_ylabel('Dämpfung [dB]')
ax1.set_zlabel('Temperatur [°C]')
plt.title('Dämpfung(30m) - Dämpfung(10m)')
plt.savefig('E:\\Projektarbeit\\Data\\Kabelmessung_20211201\\30m-10m 3D.png', dpi = 1500)
################################################### 30m - 10m ##########################################################################
...
plt.savefig('E:\\Projektarbeit\\Data\\Kabelmessung_20211201\\15m-10m 3D.png', dpi = 1500)
################################################### 15m - 10m ##########################################################################