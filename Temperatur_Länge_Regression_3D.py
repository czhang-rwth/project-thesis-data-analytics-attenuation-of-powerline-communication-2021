...
for temp30_file in os.listdir(file30m):
    ...
    for temp15_file in os.listdir(file15m):
        ...
        if temp15 == temp30:
            ...
            ax1.plot(freq15, dampf_regress, temp15)
...
plt.savefig('E:\\Projektarbeit\\Data\\Kabelmessung_20211201\\30m-15m 3D regression.png', dpi = 1500)
################################################### 30m - 15m ##########################################################################
...
for temp30_file in os.listdir(file30m):
    ...
    for temp10_file in os.listdir(file10m):
        ...
        if temp10 == temp30:
            ...
            slope, intercept, r, p, std_err = stats.linregress(freq30, dampf_achse)
            dampf_regress = [slope*a + intercept for a in freq30]
            ax1.plot(freq10, dampf_regress, temp10)

ax1.set_xlabel('Frequenz [MHz]')
ax1.set_ylabel('Dämpfung [dB]')
ax1.set_zlabel('Temperatur [°C]')
plt.title('Regression von Dämpfung(30m) - Dämpfung(10m)')
plt.savefig('E:\\Projektarbeit\\Data\\Kabelmessung_20211201\\30m-10m 3D regression.png', dpi = 1500)
################################################### 30m - 10m ##########################################################################
...
plt.savefig('E:\\Projektarbeit\\Data\\Kabelmessung_20211201\\15m-10m 3D regression.png', dpi = 1500)
################################################### 15m - 10m ##########################################################################